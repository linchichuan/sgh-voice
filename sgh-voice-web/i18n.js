...
const translations = {
    ...
    ja: {
        // Document <head>
        "meta.title": "SGH Voice — 話すだけで、プロ品質のテキストに。 v2.6.0",
        ...
        // Hero
        "hero.badge": "確認済み多言語パーソナライズ · v2.6.0",
        "hero.title1": "話すだけで、",
        "hero.title2": "プロの文章に。",
        ...
        "download.macDesc": "v2.6.0 インストーラ公開中 · Apple Silicon 版（Intel は別途配布予定）",
    ...
    /* ============================================================
       ...
       ============================================================ */
    zh: {
        "meta.title": "SGH Voice — 隨口一說，即是專業文章。v2.6.0",
        ...
        "download.macDesc": "v2.6.0 安裝包已上線 · 先提供 Apple Silicon 版（Intel 版本將另行提供）",
        "download.macCta": "Apple Silicon",
        "download.macIntel": "Intel",
    ...
    /* ============================================================
       ...
       ============================================================ */
    en: {
        "meta.title": "SGH Voice — Just speak. Get professional text. v2.6.0",
        ...
        "hero.badge": "Verified multilingual personalization · v2.6.0",
        ...
        "download.macDesc": "v2.6.0 installer available on Releases · Apple Silicon build first",
        "download.macCta": "Apple Silicon",
        "download.macIntel": "Intel",
