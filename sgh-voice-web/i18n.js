...
const translations = {
    ...
    ja: {
        // Document <head>
        "meta.title": "SGH Voice — 話すだけで、プロ品質のテキストに。 v2.4.0",
        ...
        "download.macCta": "Apple Silicon (v2.4.0)",
    ...
    /* ============================================================
       ...
       ============================================================ */
    zh: {
        "meta.title": "SGH Voice — 隨口一說，即是專業文章。v2.4.0",
    ...
    /* ============================================================
       ...
       ============================================================ */
    en: {
        "meta.title": "SGH Voice — Just speak. Get professional text. v2.4.0",
        ...
        "hero.badge": "Flow your ideas · v2.4.0",
        ...
        "hero.chip1": "✦ Filler words removed",
        "hero.chip2": "✦ Typos auto-corrected",
        "hero.chip3": "✦ Instantly formatted",
